...
USERNAME = os.environ.get("GH_USERNAME", "117119")
URL = f"https://github.com/users/{USERNAME}/contributions"
HEADERS = {
    "User-Agent": f"Mozilla/5.0 (compatible; profile-art/1.0; +https://github.com/{USERNAME})",
    "Accept": "text/html",
...
def fetch_days(retries: int = 3) -> list[dict]:
